...
public class MathSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (name=ID argumentLeft=ID? argumentsRight+=ID*)
	 */
	...
	protected void sequence_Par(ISerializationContext context, Par semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getParAccess().getExpExpParserRuleCall_2_0(), semanticObject.getExp());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=ID external+=External* mathExp=MathExp)
	 */
