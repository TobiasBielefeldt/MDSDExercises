...
public class MathPackageImpl extends EPackageImpl implements MathPackage
{
   ...
   */
  @Override
  public EReference getProgram_MathExp()
  {
   ...
   */
  @Override
  public EAttribute getExternal_ArgumentLeft()
  {
   ...
   */
  @Override
  public EAttribute getExternal_ArgumentsRight()
  {
   ...
   */
  @Override
  public EAttribute getExternalUse_Name()
  {
    return (EAttribute)externalUseEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getExternalUse_ArgumentLeft()
  {
   ...
   */
  @Override
  public EReference getExternalUse_ArgumentsRight()
  {
    return (EReference)externalUseEClass.getEStructuralFeatures().get(2);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(programEClass, PROGRAM__MATH_EXP);

    externalEClass = createEClass(EXTERNAL);
    createEAttribute(externalEClass, EXTERNAL__NAME);
    createEAttribute(externalEClass, EXTERNAL__ARGUMENT_LEFT);
    createEAttribute(externalEClass, EXTERNAL__ARGUMENTS_RIGHT);
    ...
    createEAttribute(externalUseEClass, EXTERNAL_USE__NAME);
    createEReference(externalUseEClass, EXTERNAL_USE__ARGUMENT_LEFT);
    createEReference(externalUseEClass, EXTERNAL_USE__ARGUMENTS_RIGHT);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getProgram_MathExp(), this.getMathExp(), null, "mathExp", null, 0, 1, Program.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getExternal_ArgumentLeft(), ecorePackage.getEString(), "argumentLeft", null, 0, 1, External.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getExternal_ArgumentsRight(), ecorePackage.getEString(), "argumentsRight", null, 0, -1, External.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getExternalUse_Name(), ecorePackage.getEString(), "name", null, 0, 1, ExternalUse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getExternalUse_ArgumentLeft(), this.getExpression(), null, "argumentLeft", null, 0, 1, ExternalUse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getExternalUse_ArgumentsRight(), this.getExpression(), null, "argumentsRight", null, 0, -1, ExternalUse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
