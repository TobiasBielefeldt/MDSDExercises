...
public interface MathPackage extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Argument Left</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXTERNAL__ARGUMENT_LEFT = 1;

  /**
   * The feature id for the '<em><b>Arguments Right</b></em>' attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXTERNAL__ARGUMENTS_RIGHT = 2;
  ...
  /**
   * The feature id for the '<em><b>Argument Left</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXTERNAL_USE__ARGUMENT_LEFT = EXPRESSION_FEATURE_COUNT + 1;

  /**
   * The feature id for the '<em><b>Arguments Right</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXTERNAL_USE__ARGUMENTS_RIGHT = EXPRESSION_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int EXTERNAL_USE_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 3;
  ...
  /**
   * Returns the meta object for the containment reference '{@link dk.sdu.mmmi.mdsd.math.Program#getMathExp <em>Math Exp</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Math Exp</em>'.
   * @see dk.sdu.mmmi.mdsd.math.Program#getMathExp()
   * @see #getProgram()
   * @generated
   */
  EReference getProgram_MathExp();
  ...
  /**
   * Returns the meta object for the attribute '{@link dk.sdu.mmmi.mdsd.math.External#getArgumentLeft <em>Argument Left</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Argument Left</em>'.
   * @see dk.sdu.mmmi.mdsd.math.External#getArgumentLeft()
   * @see #getExternal()
   * @generated
   */
  EAttribute getExternal_ArgumentLeft();

  /**
   * Returns the meta object for the attribute list '{@link dk.sdu.mmmi.mdsd.math.External#getArgumentsRight <em>Arguments Right</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Arguments Right</em>'.
   * @see dk.sdu.mmmi.mdsd.math.External#getArgumentsRight()
   * @see #getExternal()
   * @generated
   */
  EAttribute getExternal_ArgumentsRight();
  ...
  /**
   * Returns the meta object for the containment reference '{@link dk.sdu.mmmi.mdsd.math.ExternalUse#getArgumentLeft <em>Argument Left</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Argument Left</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ExternalUse#getArgumentLeft()
   * @see #getExternalUse()
   * @generated
   */
  EReference getExternalUse_ArgumentLeft();

  /**
   * Returns the meta object for the containment reference list '{@link dk.sdu.mmmi.mdsd.math.ExternalUse#getArgumentsRight <em>Arguments Right</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Arguments Right</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ExternalUse#getArgumentsRight()
   * @see #getExternalUse()
   * @generated
   */
  EReference getExternalUse_ArgumentsRight();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference PROGRAM__MATH_EXP = eINSTANCE.getProgram_MathExp();
    ...
    /**
     * The meta object literal for the '<em><b>Argument Left</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute EXTERNAL__ARGUMENT_LEFT = eINSTANCE.getExternal_ArgumentLeft();

    /**
     * The meta object literal for the '<em><b>Arguments Right</b></em>' attribute list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute EXTERNAL__ARGUMENTS_RIGHT = eINSTANCE.getExternal_ArgumentsRight();
    ...
    /**
     * The meta object literal for the '<em><b>Argument Left</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference EXTERNAL_USE__ARGUMENT_LEFT = eINSTANCE.getExternalUse_ArgumentLeft();

    /**
     * The meta object literal for the '<em><b>Arguments Right</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference EXTERNAL_USE__ARGUMENTS_RIGHT = eINSTANCE.getExternalUse_ArgumentsRight();
